...
export default function AplicacionesMovilesGaleria() {
  return (
    <section className="py-16 px-4 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-8 text-center text-white">Aplicaciones Móviles - Galería</h1>
      <div className="grid grid-cols-2 gap-8">
        <div className="w-full flex flex-col items-center">
          ...
          <p className="text-lg text-gray-300 text-center">Aplicación móvil multiplataforma para gestión de usuarios.</p>
        </div>
        <div className="w-full flex flex-col items-center">
          ...
          <p className="text-lg text-gray-300 text-center">App para reservas y notificaciones en tiempo real.</p>
        </div>
      </div>
    </section>
  );
