...
export default function FotografiaGaleria() {
  return (
    <section className="py-16 px-4 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-8 text-center text-white">Fotografía - Galería</h1>
      <div className="grid grid-cols-2 gap-8">
        <div className="w-full flex flex-col items-center">
          ...
          <p className="text-lg text-gray-300 text-center">Descripción detallada de la foto 1, proceso creativo, resultado y valor para el cliente.</p>
        </div>
        <div className="w-full flex flex-col items-center">
          ...
          <p className="text-lg text-gray-300 text-center">Descripción de la foto 2, contexto y explicación visual.</p>
        </div>
