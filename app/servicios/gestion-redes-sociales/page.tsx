...
export default function GestionRedesSocialesGaleria() {
  return (
    <section className="w-full min-h-screen bg-black">
      <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-center text-white pt-10">Gestión de Redes Sociales</h1>
      {/* Primera foto */}
      <div className="w-full max-w-7xl mx-auto px-0 md:px-8">
        <div className="overflow-hidden rounded-none md:rounded-3xl shadow-2xl">
          <Image src="/assets/gredes.jpg" alt="Gestión de Redes Sociales 1" width={1920} height={900} className="object-cover w-full h-[260px] md:h-[430px] lg:h-[520px] transition-all duration-500" priority />
        </div>
      </div>
      {/* Banner informativo */}
      <div className="w-full bg-black py-10 md:py-14 px-4 md:px-0 flex flex-col items-center border-y border-gray-800">
        <div className="max-w-3xl text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[#FFD600] mb-2">Impulsa tu Comunidad Digital</h2>
          <p className="text-base md:text-lg text-gray-900 dark:text-gray-200">Gestionamos tus redes sociales con estrategias personalizadas, creando contenido atractivo y relevante para fortalecer tu comunidad, aumentar tu alcance y consolidar tu presencia digital. Nos encargamos de la planificación, publicación, interacción y análisis para que tu marca destaque en el entorno digital.</p>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center py-10 bg-neutral-900 mb-8 md:mb-14">
        <div className="max-w-2xl w-full flex flex-col items-center">
          ...
          <div className="relative w-full flex flex-col gap-8 md:gap-12">
            ...
            {/* Animación puntos y línea amarilla interactiva */}
            {(() => {
              const points = [
      ...
      <div className="w-full max-w-7xl mx-auto px-0 md:px-8 mt-8 md:mt-14">
        <div className="overflow-hidden rounded-none md:rounded-3xl shadow-2xl">
          <Image src="/assets/gredes2.jpg" alt="Gestión de Redes Sociales 2" width={1920} height={900} className="object-cover w-full h-[260px] md:h-[430px] lg:h-[520px] transition-all duration-500" />
        </div>
      </div>
      ...
      <div className="w-full mt-8 md:mt-14 flex flex-col md:flex-row items-stretch rounded-xl md:rounded-3xl overflow-hidden shadow-2xl min-h-[180px]">
        ...
        <div className="w-full md:w-1/2 bg-white flex items-center justify-center p-6 md:p-12 rounded-t-xl md:rounded-l-3xl md:rounded-tr-none">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Gestión Profesional de Redes</h2>
        ...
        <div className="w-full md:w-1/2 rounded-b-xl md:rounded-r-3xl md:rounded-bl-none overflow-hidden">
          <Image src="/assets/gredes3.jpg" alt="Gestión de Redes Sociales 3" width={1920} height={900} className="object-cover w-full h-[260px] md:h-full lg:h-[520px] transition-all duration-500" />
        </div>
      </div>
    </section>
  );
