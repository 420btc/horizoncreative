  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center pt-10 sm:pt-16">
      ...
      <div className="w-full max-w-5xl mx-auto px-2 mb-16">
        <CarouselGallery
          images={[
            { src: "/assets/enboca1.jpg", alt: "Enboca Gastrobar 1" },
            { src: "/assets/enboca2.jpg", alt: "Enboca Gastrobar 2" },
            { src: "/assets/enboca3.jpg", alt: "Enboca Gastrobar 3" },
            { src: "/assets/enboca4.jpg", alt: "Enboca Gastrobar 4" },
            { src: "/assets/enboca5.jpg", alt: "Enboca Gastrobar 5" },
            { src: "/assets/enboca6.jpg", alt: "Enboca Gastrobar 6" },
          ]}
        />
      </div>
    </div>
