  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center pt-10 sm:pt-16">
      <h1 className="text-4xl sm:text-5xl font-black mb-8 text-white text-center mt-2">
        PROYECTO <span className="text-yellow-400">TENNIS CLUB MARBELLA</span> X HORIZON
      </h1>
      <div className="w-full max-w-3xl flex flex-col items-center">
        <Image
          src="/assets/golfmovil.png"
          alt="Tennis Club Marbella principal"
          width={900}
          height={500}
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8 px-2 md:px-0 mb-16">
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-bold text-yellow-400 mb-2 tracking-wide text-center">
            IDENTIDAD VISUAL & <span className="text-white">BRANDING</span>
          </h3>
          <p className="text-base text-gray-200 text-center mb-2">
            Imagen elegante y deportiva.<br />Reflejo de exclusividad y tradición tenística.
          </p>
          <ul className="list-disc list-inside text-gray-200 mb-2 text-left">
            <li><span className="text-yellow-400 font-semibold">Logotipo renovado</span> y paleta cromática deportiva.</li>
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-bold text-yellow-400 mb-2 tracking-wide text-center">
            REDES SOCIALES & <span className="text-white">COMUNICACIÓN DIGITAL</span>
          </h3>
          <p className="text-base text-gray-200 text-center mb-2">
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-bold text-yellow-400 mb-2 tracking-wide text-center">
            EXPERIENCIA DE CLUB & <span className="text-white">EVENTOS</span>
          </h3>
          <p className="text-base text-gray-200 text-center mb-2">
